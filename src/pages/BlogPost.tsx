...
<dyad-write path="src/pages/BlogPost.tsx" description="Updating BlogPost.tsx to remove sticky share sidebar and change Recommended For You to grid layout">
import { useState, useEffect } from 'react'
import { useParams, useNavigate } from 'react-router-dom'
import { supabase } from '@/lib/supabase'
import { Helmet } from 'react-helmet-async'
              ...
              {recommendedPosts.length > 0 && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    background: '#fff8f5', border: '1px solid #e8531a',
                    borderRadius: '6px', padding: '4px<dyad-write path="src/pages/BlogPost.tsx" description="Updating BlogPost.tsx to remove sticky share sidebar and change Recommended For You to grid layout">
import { useState, useEffect } from 'react'
import { useParams, useNavigate } from 'react-router-dom'
import { supabase } from '@/lib/supabase'
import { Helmet } from 'react-helmet-async'
