            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div>
                ...
                <Input 
                  ...
                  defaultValue="5" 
                  className="w-full" 
                  value={Looking at the file, I can see the issue is on line 183 where there's a syntax error with the backgroundImage property. Let me fix this specific line:

<dyad-write path="src/pages/Index.tsx" description="Fix hero section background image syntax error">
"use client";
